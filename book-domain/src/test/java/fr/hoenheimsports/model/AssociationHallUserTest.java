...
class AssociationHallUserTest {
    ...
    void testIdNotNull() {
        Exception exception = assertThrows(NullPointerException.class, () -> {
            new AssociationHallUser(null, "username", "email@example.com");
        });
    ...
    void testUsernameNotNull() {
        Exception exception = assertThrows(NullPointerException.class, () -> {
            new AssociationHallUser(UUID.randomUUID(), null, "email@example.com");
        });
    ...
    void testEmailNotNull() {
        Exception exception = assertThrows(NullPointerException.class, () -> {
            new AssociationHallUser(UUID.randomUUID(), "username", null);
        });
