...
public class GameServiceApplication {
    ...
    public GameServiceApplication(GameImportFile gameImportFile, GameDisplay gameDisplay, GameRepository gameRepository, CategoryRepository categoryRepository, ClubRepository clubRepository, TeamRepository teamRepository, HalleRepository halleRepository, GameMapper gameMapper, GenderMapper genderMapper) {
    ...
    public GameDTO createGame(GameCreateDTO gameCreateDTO) {
        ...
        Halle halle = this.halleRepository.findHallById(gameCreateDTO.halleId()).orElseThrow();
